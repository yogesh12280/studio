...
import { PlusCircle, FileText, CheckCircle, XCircle, Clock, Eye, Download } from 'lucide-react'
...
export default function ReimbursementsPage() {
  ...
  const statusBadge = (status: ReimbursementStatus) => {
    switch (status) {
      case 'Approved': return <Badge variant="success" className="gap-1"><CheckCircle className="h-3 w-3" /> Approved</Badge>
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader title="Internet Bill Reimbursements">
        {!isAdmin && (
